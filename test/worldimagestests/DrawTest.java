...
public class DrawTest extends junit.framework.TestCase
{
    ...
    {
        WorldImage t1 = AImage.makeText ("hello", 6, TextStyle.BOLD, java.awt.Color.black);
        WorldImage text1 = t1.moved(2,3);
          // WorldImage text1 = AImage.makeText("hello", 6, TextStyle.BOLD, new Black()).moved(2,3);
        WorldImage t2 = AImage.makeFromFile ("Images/shark.png");
        WorldImage fromFile1 = t2.moved(20,30);
    ...
    public void testPrimitives (Tester t)
    {
        ...
        WorldImage pent1 = AImage.makePolygon (java.awt.Color.pink,
                                     Mode.FILLED,
                                     new Posn(100, 20),
                                     new Posn(160, 50),
                                     new Posn(150, 90),
        ...
        WorldImage pent2 = AImage.makePolygon (java.awt.Color.blue,
                                     Mode.OUTLINED,
                                     new Posn(100, 20),
                                     new Posn(160, 50),
                                     new Posn(150, 90),
        ...
        WorldImage hello = AImage.makeText ("hello there", java.awt.Color.blue);
    ...
    public void testOperators (Tester t)
    {
        ...
        WorldImage label = AImage.makeText ("A snowman:", 18, TextStyle.ITALIC, java.awt.Color.black);
