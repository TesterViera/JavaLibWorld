...
class ExamplesTickyTackSong{
  ...
  void testOnTick(Tester t){
    ...
    t.checkExpect(this.tworld, 
        new TickyTackSong(new Cloud(new Posn(204, 100), 90, 60), this.sun));
  }
  ...
  void testOnKeyEvent(Tester t){
    ...
    t.checkExpect(this.tworld, 
        new TickyTackSong(this.cloud, new Sun(28)));
    TickyTackSong ttw = new TickyTackSong(this.cloud, new Sun(28));
    ttw.onKeyEvent(" ");
    t.checkExpect(ttw, new TickyTackSong(this.cloud, new Sun(1)));
