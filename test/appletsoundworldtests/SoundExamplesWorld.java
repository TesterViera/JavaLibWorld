...
class SoundWorldExamples implements SoundConstants{
	...
	void testOnTick(Tester t){
		...
		t.checkExpect(initWorld.bloons, 
				new ConsLoB(new Balloon(new Posn(25, 25), 20, new Red(), "Hap"),
						    this.mtlob));
		...
		t.checkExpect(initWorld.bloons, 
				new ConsLoB(new Balloon(new Posn(75, 25), 20, new Green(), "py"),
					new ConsLoB(new Balloon(new Posn(25, 25), 20, new Red(), "Hap"),
						this.mtlob)));
		...
		t.checkExpect(initWorld.bloons, 
				new ConsLoB(new Balloon(new Posn(125, 25), 23, new Blue(), "Birth"),
						new ConsLoB(new Balloon(new Posn(75, 25), 20, new Green(), "py"),
								new ConsLoB(new Balloon(new Posn(25, 25), 20, new Red(), "Hap"),
										this.mtlob))));
		...
		t.checkExpect(initWorld.bloons, 
				new ConsLoB(new Balloon(new Posn(185, 175), 20, new Green(), "you"),
						    this.threeBloons));
		t.checkExpect(initWorld.tickTunes.bucketSize(), 2);
