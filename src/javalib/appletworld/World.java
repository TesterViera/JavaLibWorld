...
abstract public class World{
   ...
   * and mouse adapter.
   */
  protected void initWorld(AppletCanvas theCanvas, 
                        JButton bigButton){
	...
	/**
	 * EFFECT:
	 * <p>Start the world by creating a canvas of the given size, creating
	 ...
	 * EFFECT:
   * <p>Start the world by creating a canvas of the given size, creating
	 * and adding the key and mouse adapters, without running the the timer.</p>
	 * 
	 * @param w the width of the <code>Canvas Canvas</code>
	 * @param h the height of the <code>Canvas Canvas</code>
	 */
  ...
  public void testOnTick(){
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the timer on each tick.
   ...
   * <p>User defined method to be invoked by the timer on each tick.
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the key adapter on selected key events.
	 * Delegates to the user to define a new state of the world,
	 * then resets the canvas and event handlers for the new world
	 * to those currently used.</p>
	 */
   ...
   * <p>User defined method to be invoked by the key adapter 
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the mouse adapter on mouse clicked event.
	 * Delegates to the user to define a new state of the world.</p>
	 * 
   ...
   * <p>User defined method to be invoked by the mouse adapter 
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the mouse adapter on mouse entered event.
	 * Delegates to the user to define a new state of the world.</p>
	 * 
   ...
   * <p>User defined method to be invoked by the mouse adapter 
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the mouse adapter on mouse exited event.
	 * Delegates to the user to define a new state of the world.</p>
	 * 
   ...
   * <p>User defined method to be invoked by the mouse adapter 
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the mouse adapter on mouse pressed event.
	 * Delegates to the user to define a new state of the world.</p>
	 * 
   ...
   * <p>User defined method to be invoked by the mouse adapter 
	...
	/**
	 * EFFECT:
   * <p>The method invoked by the mouse adapter on mouse released event.
	 * Delegates to the user to define a new state of the world.</p>
	 * 
