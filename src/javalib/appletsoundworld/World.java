...
abstract public class World implements SoundConstants{
  ...
  private transient ArrayList<String> pressedKeys;
  ...
  protected HashMap<String,TuneBucket> keyReleasedTunes;
   ...
   * 
   * @param myInstruments an <code>ArrayList</code> of up to 16 instrument 
   * numbers, -- must be in the range from 1 to 128
   */
   ...
   * are set to play piano.</p>
   * 
   * @param myInstruments an <code>Array</code> of up tp 16 instrument numbers, 
